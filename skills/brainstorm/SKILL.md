...
The goal is to reach a common understanding and to align.

## Workflow

1. If the user didn't provide you a topic yet, ask which topic he wants to discuss.
...
- Brainstorming can be around any topic. It is always focused on creating an artifact in the end. For example a ticket, design doc or a direct code update.
